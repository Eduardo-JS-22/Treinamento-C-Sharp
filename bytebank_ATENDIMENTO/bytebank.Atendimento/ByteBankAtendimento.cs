...
namespace bytebank_ATENDIMENTO.bytebank.Atendimento
{
    ...
    new ContaCorrente(95) {Saldo=100, Titular = new Cliente{Cpf="123", Nome="Henrique"}},
    new ContaCorrente(95) {Saldo=200, Titular = new Cliente{Cpf="456", Nome="Luiza"}},
    new ContaCorrente(94) {Saldo=60, Titular = new Cliente{Cpf="789", Nome="Pedro"}}
};
